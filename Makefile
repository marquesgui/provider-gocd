# ====================================================================================
# Setup Project
PROJECT_NAME := provider-gocd
PROJECT_REPO := github.com/marquesgui/$(PROJECT_NAME)
...
xpkg.build.provider-gocd: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider GoCD CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider GoCD controllers
...
# This target prepares repo for your provider by replacing all "gocd"
